...
S {}
E {}
N 810 -210 810 -200 {p1
lab=VDD}
N 730 -210 730 -200 {p1
lab=VSS}
...
C {devices/vsource.sym} 810 -170 0 0 {name=Vdd value="dc \{vdd\}"}
C {devices/vdd.sym} 810 -210 0 0 {name=l9 lab=VDD}
C {devices/gnd.sym} 730 -140 0 0 {name=l10 lab=GND}
C {devices/vsource.sym} 730 -170 0 0 {name=Vss value="dc 0"}
C {devices/vdd.sym} 730 -210 0 0 {name=l11 lab=VSS}
...
C {Comp_draft1.sym} 820 -320 0 0 {name=x1}
