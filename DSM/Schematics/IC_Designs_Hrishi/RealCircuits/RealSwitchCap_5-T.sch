...
C {devices/gnd.sym} 1200 -670 0 0 {name=l15 lab=GND}
C {devices/vsource.sym} 1200 -720 0 0 {name=Vresb value="dc 0 pwl(0, 0, \{per/2\}, 0, \{per/2+100p\} \{vdd\}"}
C {devices/lab_wire.sym} 1200 -790 0 0 {name=p25 sig_type=std_logic lab=resb}
