...
S {}
E {}
T {flipflop} 2310 -600 0 0 0.4 0.4 {}
...
C {devices/vsource.sym} 360 -770 0 0 {name=Vp1 value="dc 0 pulse(0, \{vdd\}, 5n, 100p, 100p, \{per/2-5n\}, \{per\}) "}
C {devices/lab_wire.sym} 360 -840 0 0 {name=p2 sig_type=std_logic lab=p1}
C {devices/gnd.sym} 720 -720 0 0 {name=l7 lab=GND}
C {devices/vsource.sym} 720 -770 0 0 {name=Vp2 value="dc \{vdd\} pulse(\{vdd\}, 0, 0, 100p, 100p, \{per/2+5n\}, \{per\})"}
...
C {devices/lab_wire.sym} 2170 -520 0 0 {name=p19 sig_type=std_logic lab=vcmp}
C {sg13g2_stdcells/sg13g2_dfrbp_1.sym} 2350 -520 0 0 {name=x1 VDD=VDD VSS=VSS prefix=sg13g2_ }
C {devices/lab_wire.sym} 2220 -540 0 0 {name=p20 sig_type=std_logic lab=p1}
C {devices/lab_wire.sym} 2220 -500 0 0 {name=p21 sig_type=std_logic lab=resb}
C {devices/lab_wire.sym} 1320 -470 0 1 {name=p22 sig_type=std_logic lab=vo2}
...
C {devices/gnd.sym} 1110 -710 0 0 {name=l15 lab=GND}
C {devices/vsource.sym} 1110 -760 0 0 {name=Vresb value="dc 0 pwl(0, 0, \{per/2\}, 0, \{per/2+100p\} \{vdd\}"}
C {devices/lab_wire.sym} 1110 -830 0 0 {name=p25 sig_type=std_logic lab=resb}
...
C {devices/lab_wire.sym} 1480 -470 0 0 {name=p24 sig_type=std_logic lab=vo2}
C {/foss/designs/SecondOrder_SingleBit_DSM/DSM/IC_Designs_Hrishi/RealCircuits/VCCS_FolCas.sym} 1360 -470 0 0 {name=x4}
C {/foss/designs/SecondOrder_SingleBit_DSM/DSM/IC_Designs_Hrishi/RealCircuits/VCCS_FolCas.sym} 700 -470 0 0 {name=x5}
