...
N 1020 -230 1050 -230 {
lab=p2}
N 1250 -400 1290 -400 {lab=Vcm}
N 1090 -440 1090 -390 {lab=#net7}
N 1230 -440 1290 -440 {lab=#net7}
...
lab=Vin}
N 1320 -440 1380 -440 {lab=vo2}
N 1380 -440 1380 -420 {lab=vo2}
N 1290 -410 1290 -400 {lab=Vcm}
N 1290 -440 1290 -430 {lab=#net7}
N 730 -450 730 -420 {lab=vo1}
N 680 -450 730 -450 {lab=vo1}
N 640 -440 640 -430 {lab=#net4}
N 640 -410 640 -400 {lab=Vcm}
N 860 -690 860 -670 {
lab=GND}
N 860 -790 860 -750 {p1
lab=p1}
N 1220 -690 1220 -670 {
lab=GND}
N 1220 -790 1220 -750 {p1
lab=p2}
...
C {devices/code_shown.sym} 2130 -240 0 0 {name=MODEL only_toplevel=true
...
C {devices/vsource.sym} 290 -710 0 0 {name=Vin value= "SIN(0 0.7 80 0 0 0)"}
C {devices/lab_wire.sym} 290 -780 0 0 {name=p15 sig_type=std_logic lab=Vin}
C {VCCS_FolCas.sym} 790 -420 2 1 {name=x3}
C {VCCS_FolCas.sym} 1440 -420 2 1 {name=x4}
C {devices/gnd.sym} 860 -670 0 0 {name=l7 lab=GND}
C {devices/vsource.sym} 860 -720 0 0 {name=Vp2 value="dc 0 pulse(0, \{vdd\}, 0, 100n, 100n, 2u, 4.5u) "}
C {devices/lab_wire.sym} 860 -790 0 0 {name=p1 sig_type=std_logic lab=p1}
C {devices/gnd.sym} 1220 -670 0 0 {name=l9 lab=GND}
C {devices/vsource.sym} 1220 -720 0 0 {name=Vp3 value="dc 0 pulse(0, \{vdd\}, 2.25u, 100n, 100n, 2u, 4.5u)"}
C {devices/lab_wire.sym} 1220 -790 0 0 {name=p24 sig_type=std_logic lab=p2}
