...
N 560 -530 560 -510 {
lab=GND}
N 560 -630 560 -590 {p1
lab=p1}
N 920 -530 920 -510 {
lab=GND}
N 920 -630 920 -590 {p1
lab=p2}
N 220 -170 220 -150 {
lab=#net1}
N 150 -230 180 -230 {
...
C {devices/gnd.sym} 560 -510 0 0 {name=l6 lab=GND}
C {devices/vsource.sym} 560 -560 0 0 {name=Vp1 value="dc 0 pulse(0, \{vdd\}, 5n, 100p, 100p, \{per/2-5n\}, \{per\}) "}
C {devices/lab_wire.sym} 560 -630 0 0 {name=p2 sig_type=std_logic lab=p1}
C {devices/gnd.sym} 920 -510 0 0 {name=l7 lab=GND}
C {devices/vsource.sym} 920 -560 0 0 {name=Vp2 value="dc \{vdd\} pulse(\{vdd\}, 0, 0, 100p, 100p, \{per/2+5n\}, \{per\})"}
C {devices/lab_wire.sym} 920 -630 0 0 {name=p1 sig_type=std_logic lab=p2}
...
C {devices/lab_wire.sym} 380 -250 0 0 {name=p3 sig_type=std_logic lab=p1}
...
C {devices/lab_wire.sym} 380 -120 0 0 {name=p5 sig_type=std_logic lab=p2}
...
C {devices/gnd.sym} 1310 -500 0 0 {name=l15 lab=GND}
C {devices/vsource.sym} 1310 -550 0 0 {name=Vresb value="dc 0 pwl(0, 0, \{per/2\}, 0, \{per/2+100p\} \{vdd\}"}
C {devices/lab_wire.sym} 1310 -620 0 0 {name=p25 sig_type=std_logic lab=resb}
...
"}
C {devices/code_shown.sym} 1710 -480 0 0 {name=NGSPICE only_toplevel=true 
value="
