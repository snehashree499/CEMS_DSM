...
In order to get all the operating points for lv nmos shown in @fig-techsweep-nmos, and lv pmos shown in @fig-techsweep-pmos
...
![Testbench for LV NMOS $\gmid$ characterization.](./DSM/Documentationfigures/tb_sg13_lv_nmos.svg){#fig-techsweep-nmos-tb}

![Testbench for LV PMOS $\gmid$ characterization.](./DSM/Documentationfigures/tb_sg13_lv_pmos.svg){#fig-techsweep-pmos-tb}