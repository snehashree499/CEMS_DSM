...
In order to get all the operating points for lv nmos shown in @fig-techsweep-nmos-tb, and lv pmos shown in @fig-techsweep-pmos-tb
...
![Testbench for LV PMOS $\gmid$ characterization.](/){#fig-techsweep-pmos-tb}