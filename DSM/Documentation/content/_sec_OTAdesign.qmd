...
![OTA Slew Currents](figures/_fig_OTA_SlewCurrents.qmd"){#fig-OTA-SlewCurrents}
...
![Time Constant Calculation](figures/_fig_RC_Calculation.qmd"){#fig-RC-Calculations}
...
![${g_\mathrm{m}}$_${I_\mathrm{D}}$ vs ${I_\mathrm{D}}$_$W$ curve for nmos](figures/_fig_gmid_vs_idw_nmos.qmd"){#fig-gm_IdvsId_W-nmos}

![${g_\mathrm{m}}$_${I_\mathrm{D}}$ vs ${I_\mathrm{D}}$_$W$ curve for pmos](figures/_fig_gmid_vs_idw_pmos.qmd"){#fig-gm_IdvsId_W-pmos}
...
### Behaviour of designed OTA {#sec-behaviour-OTA}
