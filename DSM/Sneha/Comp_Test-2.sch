...
N -390 50 -390 100 {lab=VSS}
N -390 20 -300 20 {lab=VSS}
N -300 20 -300 100 {lab=VSS}
N -390 100 -300 100 {lab=VSS}
N -530 -300 -430 -300 {lab=VSS}
N -550 100 -390 100 {lab=VSS}
N -240 -450 -70 -450 {lab=VSS}
N -750 -450 -530 -450 {lab=VSS}
N -600 -650 -530 -650 {lab=VDD}
N -240 -650 -150 -650 {lab=VDD}
N -690 -720 -620 -720 {lab=VDD}
N -920 -720 -840 -720 {lab=VDD}
N -90 -720 -10 -720 {lab=VDD}
N 100 -740 170 -740 {lab=VDD}
N 60 -910 260 -910 {lab=p1}
N -240 -390 -240 -330 {lab=#net2}
N 210 -740 260 -740 {lab=p1}
N 260 -910 260 -740 {lab=p1}
N -990 -720 -960 -720 {lab=p1}
N -990 -910 -990 -720 {lab=p1}
N -530 -370 -530 -330 {lab=#net3}
N -920 -970 -920 -750 {lab=VDD}
N -930 -970 -920 -970 {lab=VDD}
N -840 -970 -840 -720 {lab=VDD}
N -920 -970 -840 -970 {lab=VDD}
N -780 -910 -780 -720 {lab=p1}
N -990 -910 -780 -910 {lab=p1}
N -690 -970 -690 -750 {lab=VDD}
N -840 -970 -690 -970 {lab=VDD}
N -620 -970 -620 -720 {lab=VDD}
N -690 -970 -620 -970 {lab=VDD}
N -600 -970 -600 -650 {lab=VDD}
N -620 -970 -600 -970 {lab=VDD}
N -530 -970 -530 -680 {lab=VDD}
N -600 -970 -530 -970 {lab=VDD}
N -240 -970 -240 -680 {lab=VDD}
N -530 -970 -240 -970 {lab=VDD}
N -150 -970 -150 -650 {lab=VDD}
N -240 -970 -150 -970 {lab=VDD}
N -90 -970 -90 -720 {lab=VDD}
N -150 -970 -90 -970 {lab=VDD}
N -10 -970 -10 -750 {lab=VDD}
N -90 -970 -10 -970 {lab=VDD}
N 100 -970 100 -740 {lab=VDD}
N -10 -970 100 -970 {lab=VDD}
N 170 -970 170 -770 {lab=VDD}
N 100 -970 170 -970 {lab=VDD}
N 30 -720 60 -720 {lab=p1}
N 60 -910 60 -720 {lab=p1}
N -780 -910 60 -910 {lab=p1}
N -920 -690 -920 -370 {lab=#net3}
N -920 -370 -530 -370 {lab=#net3}
N -530 -420 -530 -370 {lab=#net3}
N 170 -710 170 -390 {lab=#net2}
N -240 -390 170 -390 {lab=#net2}
...
C {ipin.sym} -930 -970 0 0 {name=p5 lab=VDD}
C {ipin.sym} -550 100 0 0 {name=p7 lab=VSS}
